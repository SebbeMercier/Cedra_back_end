...
import { G as GenericEndpointContext, B as BetterAuthOptions, h as AuthContext } from '../shared/better-auth.C24xvKiK.cjs';
export { z as AuthEndpoint, D as AuthMiddleware, v as AuthPluginSchema, r as BetterAuthPlugin, I as InferOptionSchema, t as InferPluginErrorCodes, y as createAuthEndpoint, x as createAuthMiddleware, w as optionsMiddleware } from '../shared/better-auth.C24xvKiK.cjs';
...
export { A as API_KEY_TABLE_NAME, E as ERROR_CODES, a as apiKey, d as defaultKeyHasher } from '../shared/better-auth.BH54xFDQ.cjs';
...
declare const getMCPProtectedResourceMetadata: (ctx: GenericEndpointContext, options?: OIDCOptions) => {
    resource: string;
