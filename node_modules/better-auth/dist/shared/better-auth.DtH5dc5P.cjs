...
const getMigration = require('./better-auth.BmYM45vZ.cjs');
...
const socialProviders_index = require('./better-auth.PF4vmqR_.cjs');
...
const kyselyAdapter = require('./better-auth.DWpv-qG8.cjs');
